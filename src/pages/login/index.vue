...
// TODO - 上dev前要把測試資料砍了
const formData = ref({
  Username: import.meta.env.DEV ? 'rtest1105' : '',
  Password: import.meta.env.DEV ? 'test1234' : '',
  ValidCode: '',
  KeyCode: '',
  FromType: 7,
  Domain: import.meta.env.DEV ? 'nc-73.ljbdev.site' : import.meta.env.PARAMS_DOMAIN || window.location.host,
  IsApp: 0,
  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 px-4 sm:px-6 lg:px-8">
    ...
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        <div class="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl shadow-lg mb-4">
        ...
        <form @submit.prevent="handleLoginBtnClick" class="space-y-5">
          ...
          <div>
            ...
            <div class="flex gap-3">
              ...
              <div class="flex items-center gap-2">
                <div class="captcha-box flex items-center justify-center w-24 sm:w-28 h-12 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg border-2 border-gray-300 select-none cursor-not-allowed">
                  <img
                    v-if="captchaCode"
          ...
          <div v-if="showGoogleLogin">
            <div class="flex-1 relative">
              ...
              <input
                id="captcha"
                v-model="googleFormData.ValidCode"
                type="text"
                required
                placeholder="請輸入Google驗證碼"
                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors text-sm sm:text-base uppercase"
              />
            </div>
          </div>
